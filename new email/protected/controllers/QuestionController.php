...
class QuestionController extends Controller
{
	...
	{		
		...
		$model->setAttribute('answer_1',$_POST['answer_1']);
		$model->setAttribute('answer_2',$_POST['answer_2']);
		$model->setAttribute('answer_3',$_POST['answer_3']);
		$model->setAttribute('answer_4',$_POST['answer_4']);
		$model->save();
